...
public class exercicio2 {
    ...
    public static void main(String[] args) {
        ...
        double moedas = valor - notas;
        System.out.printf("%.2f", moedas);
        ...
        moedas -= moedas50 * 50;
        int moedas25 = (int) (moedas / 25);
        moedas -= moedas25 * 25;
        int moedas10 = (int) (moedas / 10);
        moedas -= moedas10 * 10;
        int moedas05 = (int) (moedas / 5);
        moedas -= moedas05 * 5;
        int moedas01 = (int) moedas;
