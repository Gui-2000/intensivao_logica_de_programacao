...
public class exercicio12 {
    //usando o treeMap;
    //12:Retorna o antecessor da arvore passada como referencia no parametro metodo lowerKey(referencia);
    public static void main(String[] args) {
        ...
        System.out.println("A Serie que antecede Stranger Things é: " + protagonistasDasSeries.lowerKey("Stranger Things"));
    }
}
