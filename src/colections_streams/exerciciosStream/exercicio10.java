...
public class exercicio10 {
    //10:Tem algum elemento com a letra m minusculo no nome?;
    public static void main(String[] args) {
        ...
        System.out.println("Tem algum elemento com a letra m minusculo no nome? " + personagens.stream().anyMatch(elemento -> elemento.contains("m")));
    }
}
